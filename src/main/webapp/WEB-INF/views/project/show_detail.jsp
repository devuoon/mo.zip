  ...
  <div class="wrap flex">
    <div class="content">
      <div class="main-contents">
        ...
        <p class="content">
          열심히 코딩해서 멋진 개발자가 인재들을 모집합니다. 많은 지원바랍니다! 열심히 코딩해서 멋진 개발자가 인재들을 모집합니다. 많은 지원바랍니다!
        </p>
        <p class="title-contents">프로젝트에 사용한 기술 스택</p>
        <ul class="stack-icon">
          ...
          <li class="css_icon"> TypeScript</li>
        </ul>
        <ul class="stack-icon">
          ...
          <li><img src="/resources/static/img/vueJs_icon.png" class="vueJs_icon_img"></li>
        ...
        <p class="title-contents">댓글 3개 </p>
        <div class="app-wrap-show">
          <div class="application-box">
            <div class="profile-top-show">
              <img src="/resources/static/img/profile_sample.png" alt="">
              <div>
                <h3>이윤지</h3>
                <p class="box-count">2024년 4월 30일</p>
              </div>
              <!-- <button class="addmem-button add">답글</button> -->
            </div>
            <p class="comment">
              프로젝트 잘 보고 갑니다~
            </p>
        ...
        <div class="aplly-box">
          ...
          <input type="text" class="comment-write" placeholder=" 댓글을 입력하세요. "></input>
          <!-- <div class="comment-write"></div> -->
          <button class="aplly-try">댓글달기</button>
          <!-- 댓글 달기 버튼 삭제..?-->
        </div>
      </div>
    </div>
    ...
    <div class="right-box-show">
      ...
      <a href="https://github.com/LegdayDev" target="_blank">
        <button class="right-btn confirm-show"><i
          class="fa-brands fa-github"></i>깃허브 링크
        </button>
      </a>
      <div class="edit-btn">
        <a href="show_create.html">
          <button class="right-btn">수정</button>
        </a>
        <button class="right-btn open-modal">삭제</button>
      </div>
      <div class="sc-member-list">
        <div class="sc-title-box">
          <p class="sc-title-show">👩‍👦‍👦 프로젝트 참여 멤버</p>
